...
| 子系统 | 接口 | 内置实现（节选） | 扩展方式 |
|---|---|---|---|
| AI Models | `Provider` | OpenRouter、Anthropic、OpenAI、Azure OpenAI、Gemini、Vertex AI、Ollama、Groq、Mistral、xAI、DeepSeek、Together、Fireworks、Perplexity、Cohere、Bedrock、Venice、NEAR AI Cloud 等 50+ | 添加 provider 实现并注册 |
